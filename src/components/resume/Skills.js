    ...
    <div className="w-full grid grid-cols-9 gap-10 lgl:gap-0 px-6">
      ...
      <div className="col-span-9 md:col-span-4">
        ...
        <div className="py-4">
          ...
          {/* UI Design */}
          <div className="py-3 border-b-[1px] border-zinc-800">
            <p className="text-base text-textColor -mb-1.5">Devops</p>
            <span className="w-full bg-zinc-600 h-1 inline-flex relative">
      ...
      <div className="col-span-9 md:col-span-4">
        ...
        <div className="py-4">
          ...
          {/* UI Design */}
          <div className="py-3 border-b-[1px] border-zinc-800">
            <p className="text-base text-textColor -mb-1.5">Python Django</p>
            <span className="w-full bg-zinc-600 h-1 inline-flex relative">
          ...
          {/* UI Design */}
          <div className="py-3 border-b-[1px] border-zinc-800">
            <p className="text-base text-textColor -mb-1.5">AWS Lamda</p>
            <span className="w-full bg-zinc-600 h-1 inline-flex relative">
              <span className="w-[70%] h-full absolute top-0 left-0 bg-designColor"></span>
            </span>
          </div>
           {/* UI Design */}
           <div className="py-3 border-b-[1px] border-zinc-800">
            <p className="text-base text-textColor -mb-1.5">Kubernetes</p>
            <span className="w-full bg-zinc-600 h-1 inline-flex relative">
           ...
           {/* UI Design */}
           <div className="py-3 border-b-[1px] border-zinc-800">
            <p className="text-base text-textColor -mb-1.5">Jenkins</p>
            <span className="w-full bg-zinc-600 h-1 inline-flex relative">
